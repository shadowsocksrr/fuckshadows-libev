...
#define sc_bufSize (2 * sc_blockSize)
    ...
    //
#define sc_const  ((uint64_t)0xdeadbeefdeadbeefLL)
...
/* begin public */
	...
	*/
    ...
    void SpookyHashInit(
        ...
        uint64 seed2,
		spooky_state *state);      // different seeds produce independent hashes
    
    //
    // Update: add a piece of a message to a SpookyHash state
    //
    void SpookyHashUpdate(
        const void *message,  // message fragment
        size_t length,
		spooky_state *state);       // length of message fragment in bytes
    ...
    //
    void SpookyHashFinal(
        uint64 *hash1,    // out only: first 64 bits of hash value.
        uint64 *hash2,
		spooky_state *state);   // out only: second 64 bits of hash value.
...
static inline void SpookyHashMix(const uint64_t* data, uint64_t* s0,
...
static inline void SpookyHashEndPartial(uint64_t* h0, uint64_t* h1,
...
static inline void SpookyHashEnd(const uint64_t *data, uint64_t *h0,
  ...
  *h8 += data[8];   *h9 += data[9];   *h10 += data[10]; *h11 += data[11];
  SpookyHashEndPartial(h0, h1, h2, h3, h4, h5, h6, h7, h8, h9, h10, h11);
  SpookyHashEndPartial(h0, h1, h2, h3, h4, h5, h6, h7, h8, h9, h10, h11);
  SpookyHashEndPartial(h0, h1, h2, h3, h4, h5, h6, h7, h8, h9, h10, h11);
}
...
static inline void SpookyHashShortMix(uint64_t* h0, uint64_t* h1, uint64_t* h2,
                                   uint64_t* h3) {
...
static inline void SpookyHashShortEnd(uint64_t* h0, uint64_t* h1,
                                        uint64_t* h2, uint64_t* h3) {
